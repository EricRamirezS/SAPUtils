...
namespace SAPUtils.Utils
{
    ...
    public interface ILogger
    {
        ...
        /// <summary>
        /// Logs a trace-level message generated by a factory delegate.
        /// </summary>
        /// <param name="messageFactory">A function that produces the log message, evaluated only if tracing is enabled.</param>
        void Trace(
        ...
        /// <summary>
        /// Logs a debug-level message generated by a factory delegate.
        /// </summary>
        /// <param name="messageFactory">A function that produces the log message, evaluated only if debug is enabled.</param>
        void Debug(
            Func<string> messageFactory,
            [CallerMemberName] string callerName = "",
            [CallerFilePath] string callerFile = "",
        ...
        /// <summary>
        /// Logs a Info-level message generated by a factory delegate.
        /// </summary>
        /// <param name="messageFactory">A function that produces the log message, evaluated only if information is enabled.</param>
        void Info(
            Func<string> messageFactory,
            [CallerMemberName] string callerName = "",
            [CallerFilePath] string callerFile = "",
        ...
        /// <summary>
        /// Logs a warning-level message generated by a factory delegate.
        /// </summary>
        /// <param name="messageFactory">A function that produces the log message, evaluated only if warning is enabled.</param>
        void Warning(
            Func<string> messageFactory,
            [CallerMemberName] string callerName = "",
            [CallerFilePath] string callerFile = "",
        ...
        /// <summary>
        /// Logs a error-level message generated by a factory delegate.
        /// </summary>
        /// <param name="messageFactory">A function that produces the log message, evaluated only if error is enabled.</param>
        void Error(
            Func<string> messageFactory,
            [CallerMemberName] string callerName = "",
            [CallerFilePath] string callerFile = "",
        ...
        /// <summary>
        /// Logs a Critical-level message generated by a factory delegate.
        /// </summary>
        /// <param name="messageFactory">A function that produces the log message, evaluated only if critical is enabled.</param>
        void Critical(
            Func<string> messageFactory,
            [CallerMemberName] string callerName = "",
            [CallerFilePath] string callerFile = "",
