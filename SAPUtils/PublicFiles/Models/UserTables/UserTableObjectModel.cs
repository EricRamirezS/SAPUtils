...
using SAPUtils.Internal.Repository;
...
namespace SAPUtils.Models.UserTables {
    ...
    public abstract class UserTableObjectModel : IUserTableObjectModel {
        ...
        public static List<T> GetAll<T>() where T : IUserTableObjectModel, new() {
            ...
            UserTableAttribute userTable = UserTableMetadataCache.GetUserTableAttribute(typeof(T));
            if (userTable == null) {
    ...
    public class UserTableObjectModel<T> : UserTableObjectModel where T : UserTableObjectModel<T>, new() {
        ...
        private readonly UserTableAttribute _userTableAttribute;
        private static ILogger Log => Logger.Instance;
        ...
        public static List<T> GetAll() {
            return UserTableObjectModel.GetAll<T>();
        }
            ...
            try {
                ...
                if (exist) {
                    ...
                    if (this is IAuditableUser userAudit)
                    {
                        ...
                        userAudit.UpdatedBy = SapAddon._company.UserSignature;
                    }
                }
                else {
                    ...
                    if (this is IAuditableUser userAudit)
                    {
                        userAudit.CreatedBy = SapAddon._company.UserSignature;
                        userAudit.UpdatedBy = SapAddon._company.UserSignature;
                    }
                }
        ...
        private void GenerateCode(PrimaryKeyStrategy primaryKeyStrategy, UserTable table) {
